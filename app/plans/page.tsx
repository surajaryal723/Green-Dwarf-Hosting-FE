...
export default function HostingPlans(){
    ...
    return <div>
        <Breadcrumb title="Hosting Plans" />
     ...
     <Boundary>
        <h2 className="text-[2.2rem] leading-[2.8rem] translate-y-[100%] animate-y text-white section-heading">
          Compare Different Plans
        </h2>
      </Boundary>
     </div>
      <div className="w-full flex  gap-5 py-20 justify-center overflow-hidden plan-cards">
